...
# Read in data
admission_recruitment = pd.read_feather("/sc-projects/sc-proj-ukb-cvd/projects/llm2vec/data/codes_admin_231012_mapped_eids_filtered.feather")

big_dataset_path = "/sc-projects/sc-proj-ukb-cvd/projects/llm2vec/data/dataportal_final_records_omop_240625_mapped_eids_withorigin.feather" #from script mapping_eids_records
...
updated_df.to_feather("/sc-projects/sc-proj-ukb-cvd/projects/llm2vec/data/dataportal_final_records_omop_240625_mapped_eids_inpatient_updated.feather")

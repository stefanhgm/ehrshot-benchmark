...
def plot_one_labeling_function(df: pd.DataFrame,
    ...
    model_order = ['count', 'clmbr', 'llm-bert', 'llm', 'llm-harrier']
    ...
    for m_idx, model in enumerate(models):
        ...
        for h_idx, head in enumerate(heads):
            ...
            marker = 'D' if 'harrier' in model.lower() else ('o' if 'clmbr' in model.lower() else ('^' if 'llm-bert' in model.lower() else ('X' if 'llm' in model.lower() else 'p')))
